//네이티브(오리지널-옛날부터)자바스크립트로 메뉴액션 구현(아래)
...
//네이티브 자바스크립트로 메뉴 제어 하기 : 위에서 부터 아래로 실행됩니다(그래서 에러가 났었음).
//document.getElementsById 는 1개의값만 리턴(출력) 됩니다.
//document.getElementsByClassName 는 배열 값을 리턴(출력) 됩니다.
/* window.onload = document_ready; //문서를 미이 읽어들이고, 함수를 실행합니다. j쿼리의 $(document).ready()
