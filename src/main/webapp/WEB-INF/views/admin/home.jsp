	          ...
	          <ul class="users-list clearfix">
		          <c:forEach items="${latest_member}" var="memberVO">
		            <li>
		              ...
		              <a class="users-list-name" href="/admin/member/member_view?page=1&user_id=${memberVO.user_id}">${memberVO.user_name}</a>
	              ...
	              <div class="card-body p-0">
	                <div class="table-responsive">
	                  <table class="table m-0">
	                    ...
	                    <tbody>
	                    <!-- 대시보드 만들기 2번째 방법(2가지 중) / 효율적이다. / adminController에서 476참고. -->
	                    <!-- 파일 import 시 매개변수 board_type=${boardTypeVO.board_type} -->
